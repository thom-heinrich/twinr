...
class ReSpeakerLedCompanionTests(unittest.TestCase):
    def test_optional_respeaker_led_companion_starts_and_stops_loop(self) -> None:
        loop = _FakeLedLoop()
        emitted: list[str] = []
        ...
        self.assertIn("respeaker_led_companion=started", emitted)

    def test_optional_respeaker_led_companion_skips_when_loop_is_already_running(self) -> None:
        created = False
