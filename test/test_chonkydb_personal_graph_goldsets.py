...
class TwinrPersonalGraphGoldsetTests(unittest.TestCase):
    ...
    def test_goldset_lookup_queries_cover_exact_role_family_and_miss_cases(self) -> None:
        cases = (
            ...
            ({"name": "Corinna", "family_name": "Maier"}, "found", "Corinna Maier", ("5551234",), 0),
            ({"name": "Corinna", "role": "Physiotherapist"}, "found", "Corinna Maier", ("5551234",), 0),
            ({"name": "Corinna", "role": "Neighbor"}, "found", "Corinna Schmidt", ("5559988",), 0),
            ({"name": "Anna"}, "found", "Anna Becker", ("5552345",), 0),
    ...
    def test_goldset_context_keeps_contact_disambiguation_facts_available(self) -> None:
        ...
        self.assertEqual(contacts["Corinna Maier"]["phones"], ["5551234"])
    ...
    def test_goldset_first_name_contact_can_be_enriched_later_when_number_matches(self) -> None:
        ...
        self.assertEqual(lookup.match.phones, ("5551234",))
