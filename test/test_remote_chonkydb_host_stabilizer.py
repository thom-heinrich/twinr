...
class RemoteChonkyDBHostStabilizerTests(unittest.TestCase):
    ...
    def test_probe_public_host_availability_only_requires_instance_probe(self) -> None:
        with patch(
            "twinr.ops.remote_chonkydb_host_stabilizer._probe_http_json",
        ...
        self.assertEqual(
            mock_probe.call_args.kwargs["url"],
            "https://tessairact.com:2149/v1/external/instance",
        )
