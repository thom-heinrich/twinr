...
class GestureCalibrationProfile:
    ...
    def defaults(cls) -> "GestureCalibrationProfile":
        ...
        return cls(
            fine_hand={
                SocialFineHandGesture.THUMBS_UP: FineHandGesturePolicy(0.68, 1, 0.35),
                SocialFineHandGesture.THUMBS_DOWN: FineHandGesturePolicy(0.78, 1, 0.35),
                SocialFineHandGesture.POINTING: FineHandGesturePolicy(0.70, 1, 0.32),
                SocialFineHandGesture.PEACE_SIGN: FineHandGesturePolicy(0.78, 1, 0.40),
