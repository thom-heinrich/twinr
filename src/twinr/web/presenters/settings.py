        ...
        SettingsSection(
            ...
            fields=(
                _text_field(
                    ...
                    tooltip_text="Main non-coding text model. Search, supervisor, first-word, conversation closure, long-term-memory text compilation, and reserve generation inherit this unless you set a dedicated override.",
                ),
                _select_field(
        ...
        SettingsSection(
            ...
            fields=(
                ...
                _text_field(
                    ...
                    tooltip_text="Model used when Twinr performs a web-backed response. Leave it unset to inherit the main LLM model.",
                ),
                _select_field(
