        ...
        SettingsSection(
            ...
            fields=(
                ...
                _select_field(
                    ...
                    help_text=(
                        "STT works without a custom model but is slower. "
                        "openWakeWord runs locally and needs one or more configured wakeword models."
                    ),
                    tooltip_text="Choose whether Twinr uses speech-to-text phrase spotting or the local openWakeWord detector.",
                ),
                _text_field(
                ...
                _select_field(
                    "TWINR_WAKEWORD_OPENWAKEWORD_TRANSCRIBE_ON_DETECT",
                    "Transcribe after detect",
                    env_values,
                    _BOOL_OPTIONS,
                    "true" if config.wakeword_openwakeword_transcribe_on_detect else "false",
                    tooltip_text="If enabled, Twinr transcribes the detection window to keep any remaining spoken text after the wakeword.",
                ),
            ),
        ),
        SettingsSection(
