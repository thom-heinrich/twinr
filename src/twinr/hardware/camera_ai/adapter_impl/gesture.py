...
class AICameraAdapterGestureMixin:
    ...
    _LEGACY_PUBLIC_GESTURE_DEBUG_KEYS = (
        ...
        "live_builtin_gesture",
        "live_builtin_confidence",
        "live_custom_gesture",
        "live_custom_confidence",
        "live_custom_enabled",
        ...
        "current_live_result_wait_s",
        "current_live_builtin_ready",
        "current_live_custom_ready",
        "live_builtin_submitted",
        "live_custom_submitted",
        "fresh_live_results_confirm_no_hand",
        "gesture_fast_path",
        "gesture_observe_policy",
        "observe_policy",
        "observe_policy_allow_full_frame_hand_recovery",
        ...
        "temporal_reason",
        "temporal_votes",
        "temporal_output_gesture",
        "temporal_output_confidence",
        "temporal_output_changed",
        "temporal_resolved_source",
        ...
        "person_roi_match_index",
        "person_roi_pose_hint_match_index",
        "person_roi_builtin_gesture",
        "person_roi_builtin_confidence",
        "person_roi_custom_gesture",
        "person_roi_custom_confidence",
        "person_roi_combined_gesture",
        "person_roi_combined_confidence",
        "person_roi_combined_source",
        "person_roi_short_circuit_used",
        "person_roi_short_circuit_index",
        "person_roi_short_circuit_confidence",
        "person_roi_short_circuit_reason",
        "person_roi_detection_debug",
        "sync_custom_recovery_enabled",
        "sync_custom_recovery_reason",
        "live_stream_recovery_gate",
        "live_roi_builtin_gesture",
        "live_roi_builtin_confidence",
        "live_roi_custom_gesture",
        "live_roi_custom_confidence",
        "live_roi_combined_gesture",
        "live_roi_combined_confidence",
        "live_roi_detection_debug",
        "full_frame_hand_attempt_reason",
        "full_frame_hand_detection_count",
        "full_frame_hand_detection_debug",
        "full_frame_hand_builtin_gesture",
        "full_frame_hand_builtin_confidence",
        "full_frame_hand_custom_gesture",
        "full_frame_hand_custom_confidence",
        "full_frame_hand_combined_gesture",
        "full_frame_hand_combined_confidence",
