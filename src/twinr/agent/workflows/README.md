...
- give pure search handoffs their own wider final-lane timeout budget so live web/search turns are not cut off by the shorter direct-reply watchdog envelope
