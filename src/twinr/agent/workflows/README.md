...
| [realtime_runtime/nightly_digest_refinement.py](./realtime_runtime/nightly_digest_refinement.py) | User-facing nightly refinement layer for calmer news lines, supporting source selection, and German morning-facing insight/continuity phrasing |
