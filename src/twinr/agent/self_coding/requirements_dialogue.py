...
# AUDIT-FIX(#1): Preserve a rollback baseline without changing the public session schema.
_INTERNAL_BASELINE_ACTION_KEY = "__baseline_action__"
_INTERNAL_BASELINE_TRIGGER_MODE_KEY = "__baseline_trigger_mode__"
_INTERNAL_BASELINE_TRIGGER_CONDITIONS_KEY = "__baseline_trigger_conditions__"
_INTERNAL_BASELINE_SCOPE_KEY = "__baseline_scope__"
_INTERNAL_BASELINE_CONSTRAINTS_KEY = "__baseline_constraints__"
_INTERNAL_ANSWER_SUMMARY_KEYS: frozenset[str] = frozenset(
    {
        _INTERNAL_BASELINE_ACTION_KEY,
        _INTERNAL_BASELINE_TRIGGER_MODE_KEY,
        _INTERNAL_BASELINE_TRIGGER_CONDITIONS_KEY,
        _INTERNAL_BASELINE_SCOPE_KEY,
        _INTERNAL_BASELINE_CONSTRAINTS_KEY,
    }
)
