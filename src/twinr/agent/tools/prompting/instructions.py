...
COMPACT_TOOL_AGENT_INSTRUCTIONS = (
    ...
    "Use confirm_skill_activation only after explicit approval to enable a compiled learned skill, and use rollback_skill_activation when the user wants the previous learned version restored. "
