...
COMPACT_TOOL_AGENT_INSTRUCTIONS = (
    ...
    "Use list_smart_home_entities for smart-home discovery, filtered state queries, and grouped smart-home counts, use read_smart_home_state only for exact known entity IDs, use control_smart_home_entities only for explicit low-risk device-control requests, and use read_smart_home_sensor_stream only when the user wants current smart-home event activity. "
