...
- Live smart-home signals should enter runtime fusion as optional `room_context` and `home_context`, not as a replacement for local `near_device_presence`. The target runtime split for that path lives in [`../../../../docs/SMART_HOME_RUNTIME_CONTEXT_MODEL_V1.md`](../../../../docs/SMART_HOME_RUNTIME_CONTEXT_MODEL_V1.md).
